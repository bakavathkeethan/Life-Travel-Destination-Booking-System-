                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage Inquiries</h2>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        <a href='manage-inquiries.php?id=" . $row['id'] . "&del=delete' onClick='return confirm(\"Are you sure you want to delete?\")' class='btn btn-danger btn-xs'>Delete</a>
...
<?php
    ...
    if (isset($_GET['del']) && $_GET['del'] == 'delete' && isset($_GET['id'])) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('inquiries deleted successfully!'); window.location.href='manage-inquiries.php';</script>";
        } else {
            echo "<script>alert('Error deleting inquiries: " . $conn->error . "');</script>";
        }
