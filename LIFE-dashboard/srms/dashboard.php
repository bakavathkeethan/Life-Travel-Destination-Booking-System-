...
<html lang="en">
    <head>
        ...
        <title>Life Travel Management System | Dashboard</title>
...
?>
                                            ...
                                            <span class="name">Total Booking</span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                        <a class="dashboard-stat bg-warning" href="manage-Packages.php">
                                        <?php 
...
?>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome to Life Travel Management System!");
