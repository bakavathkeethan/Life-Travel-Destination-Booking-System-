				...
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="intro_content">
							...
							<p class="intro_text">Welcome to Life Travel, your ultimate companion for exploring the world and creating lifelong memories! This space is dedicated to sharing unique travel stories, practical tips, and guides to inspire your wanderlust. Whether you’re a seasoned adventurer or just starting to explore, Life Travel celebrates the beauty of discovery—connecting you to diverse cultures, breathtaking destinations, and transformative experiences. Let’s embrace the journey, find joy in the little moments, and uncover the endless wonders this planet has to offer. Life Travel isn’t just about destinations; it’s about living the journey. Ready to explore? Let’s go!</p><br>
							<br><br><br><br><div class="button intro_button">
				...
				<div class="row">
					<div class="col">
						<div class="add_container">
							<div class="add_background" style="background-image:url(images/rafting-sri-lanka-3.jpg)"></div>
							<div class="add_content">
								<h1 class="add_title">kiththukala</h1>
								<div class="add_subtitle">From <span>$24</span></div>
